...
To expand the blast radius, one might try to show that rival views—such as deontological or virtue ethical theories—_fare no better_ and have implications no less counterintuitive, in the relevant area, than those of utilitarianism. An issue can't give you overall reason to prefer a rival view if that rival view is equally undermined by careful consideration of the issue.
