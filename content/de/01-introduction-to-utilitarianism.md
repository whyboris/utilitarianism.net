...
[^8]:
     Zu extremer Armut siehe: Singer, P. (2009). _[The Life You Can Save: Acting Now to End World Poverty](https://www.thelifeyoucansave.org/the-book/)_. Bainbridge Island, WA: Penguin Random House LLC. Eine kostenlose deutsche Übersetzung mit dem Titel [Leben retten!](https://effektiv-spenden.org/leben-retten-buch/) ist verfügbar.
    Zu Massentierhaltung siehe: Singer, P. (1975). _[Animal Liberation: A New Ethics for Our Treatment of Animals](https://en.wikipedia.org/wiki/Animal_Liberation_(book))_. New York: HarperCollins.

[^9]:
     Am deutlichsten ist dies in Fällen mit fester Bevölkerungszahl, in dem die eigenen Handlungen keinen Einfluss auf die Anzahl oder Identität von Menschen haben. Komplexere Fälle werden in den Erörterungen zu Populationsethik in Kapitel 5 besprochen.
...
[^12]:
     ...
     Diese Definition gilt für ein Umfeld mit gleichbleibender Bevölkerung, in dem die eigenen Handlungen keinen Einfluss auf die Anzahl oder Identität von Menschen haben. Es gibt aggregationistische Theorien, die sich darin unterscheiden, wie sie mit variablen Populationen umgehen. Dies ist eine technische Frage, die für die Diskussion von [Populationsethik](https://utilitarianism.net/population-ethics/)  in Kapitel 5 relevant ist. Ferner ist zu beachten, dass Nicht-Welfaristen auch andere Dinge als Leben als Wertbeitrag für die Welt ansehen könnten, die dann in die Summe einbezogen werden müssten. Wir klammern diese Möglichkeit zur Vereinfachung der Darstellung aus.
