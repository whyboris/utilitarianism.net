...
Todas as teorias éticas na família utilitarista partilham de quatro elementos definidores: o consequencialismo, o bem-estarismo, a imparcialidade e o agregacionismo, os quais definiremos da seguinte forma:.
...
Proeminentes [objeções ao utilitarismo](https://www.utilitarismo.net/objections-to-utilitarianism/) são abordadas no Capítulo 8. Apresentamos um “[kit de ferramentas](https://www.utilitarismo.net/objections-to-utilitarianism/#the-utilitarians-toolkit)” de manobras gerais disponíveis aos utilitaristas para lidar com uma ampla gama de objeções e daí mostramos como esse kit pode ser utilizado para lidarmos com preocupações com direitos, exigências, desinformação e mais.
...
[^10]:
     No entanto, quando os economistas utilizam o termo “[utilidade](https://en.wikipedia.org/wiki/Utility)”, eles tipicamente se referem, em vez disso, à representação numérica das preferências de um indivíduo.

[^11]:
     Utilizamos “felicidade” para nos referir a experiências conscientes agradáveis. O [Capítulo 4: Teorias do Bem-Estar](https://www.utilitarismo.net/theories-of-wellbeing/) explora a questão sobre se o bem-estar pode envolver mais do que isso.

[^12]:
     Essa definição se aplica a uma configuração populacional fixa,  na qual as nossas ações não afetam o número ou a identidade das pessoas. Há teorias agregacionistas que diferem no modo como lidam com configurações populacionais variáveis. Essa é uma questão técnica, relevante para a discussão sobre [ética populacional](https://www.utilitarismo.net/population-ethics) no Capítulo 5. Observe ainda que os não bem-estaristas podem considerar que coisas além de vidas contribuem com valor para o mundo, o que então precisaria ser incluído na soma. Colocamos essa possibilidade entre parentes, por assim dizer, para facilitar a exposição.
