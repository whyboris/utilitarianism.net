...
Una mejora Pareto es mejor para algunas personas y peor para ninguna. Cuando los resultados son inciertos, podemos evaluar la _perspectiva_ asociada a una acción: el abanico de posibles resultados, ponderados por la probabilidad de cada uno. Se puede considerar que una perspectiva es mejor para una persona cuando le ofrece un mayor bienestar [en términos esperados](./elementos-y-tipos-de-utilitarismo.md#utilitarismo-expectacional-versus-utilitarismo-objetivo), o _ex ante_.[^12] Uniendo estos conceptos, podemos formular el siguiente principio:
