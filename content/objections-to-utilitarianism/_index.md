...
There are further argumentative moves that utilitarians often find it useful to appeal to in developing the above general strategies.
...
- More generally, utilitarians may seek to reduce their apparent conflict with commonsense by _identifying nearby intuitions_ that they _can_ accommodate. For example, if critics claim that a specific utility-maximizing action is intuitively _wrong_, utilitarians may argue that our intuition here is better thought of tracking one of the following features:
...
- Some utilitarian verdicts feature a degree of starkness or demandingness that can seem objectionable in ordinary circumstances, while still being less than could plausibly be justified in wartime. But in fact our "ordinary circumstances" involve horrific amounts of preventable suffering, with stakes as high as any war. Utilitarian verdicts may thus be bolstered by noting that much sentient life is (metaphorically) under siege, and that some moral heroism may accordingly not be too much to ask if truly needed to set things right.

You can find each of these standard moves employed, where appropriate, in our responses to the various specific objections listed below. (Students are encouraged, when reading an objection for the first time, to anticipate how the utilitarian's toolkit might best be applied to address the objection at hand.)
